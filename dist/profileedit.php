...
<div class="flex items-center justify-center mt-6">
        <p class="text-black dark:text-white font-normal text-2xl -ml-40">Edit profile</p>
</div>
<div class="flex items-center justify-center mt-14">
    <div>
        ...
        if ($result['profilepicture'] == NULL) {
            echo '<img id="profilepicturechange" class="rounded-full w-16 h-16" src="./pictures/defaultprofile.jpg" alt="image">';
        } else {
            echo '<img id="profilepicturechange" class="rounded-full w-16 h-16" src="data:image/jpeg;base64,' . $encodedProfilePic . '" alt="image">';
        }
        ?>
    </div>
    <div class="ml-4">
        <p class="text-black dark:text-white"><?php echo $result['user_name']; ?></p>
        <form action="connection.php" method="post" enctype="multipart/form-data">
         <input class="hidden" type="text" name="profileid" value="<?php echo $profile_id ?>">
